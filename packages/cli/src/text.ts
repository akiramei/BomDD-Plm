...
import type { Diagnostics, Finding } from "@bomdd/core";
import { appliedRules } from "@bomdd/core";
import type { RefSchema } from "@bomdd/core";

export function formatText(diag: Diagnostics, schema: RefSchema): string {
