...
- 原資料: `bomdd/ui/mock/bomdd-plm-viewer.html`(**たたき台 v0.1** — 設計者AI作成。akira の改稿・承認前)
...
- 注意: **モックが承認されるまで UI-CAD パッケージは draft**。akira 改稿時は data-ui-id を保存し(意味が変わらない限り変更しない)、差分を IR に反映する。
